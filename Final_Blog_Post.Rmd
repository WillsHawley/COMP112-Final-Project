...
It was difficult to prove any causal relationship because the data was difficult to use and our inexperience with statistics. So we had to find a way to display some sort of relationship clearly and concisely. Using the hex plots and box plots we found a good way to show several different aspects of the data. When experimenting with the data we were able to pick out different relationships using our plots in conjunction. We wanted to know what factors affect the popularity of a song. However, other factors may influence popularity that aren't in the data set that is worth taking into account when trying to infer effects on popularity. These include the popularity of the artist, and genre in current culture, and the lyrics in the song. Although, after completing our project we discovered that the variables that affect popularity are the valence and the energy of the song. 
