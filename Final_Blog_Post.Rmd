...
* Here we see that there is major variability based on the genre. Clearly, there are more popular genres than others 
...
* On Plot 1 you can see that there is a Geometric Hexagonal plot

  * An example comparison can be made between the Soul and Electronic genre
  
      * Danceability of the majority of songs is about the same, while the Energy
        rating is higher for the Electronic genre
