...
* This is the second kind of data we wanted to display. In looking at a two variable comparison by genre, we were more able to look at trends within given genres, rather than simply relying on single variable comparissons by genre. 
